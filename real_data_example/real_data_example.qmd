...
### Preprocessing and Setup for Nullstrap
...
cat("Number of selected features by Nullstrap (param):", num_feature, "\n")
cat("R-squared of Nullstrap (param):", r_squared, "\n")
```
...
cat("Number of selected features by Nullstrap (non-param):", num_feature, "\n")
cat("R-squared of Nullstrap (non-param):", r_squared, "\n")
```
